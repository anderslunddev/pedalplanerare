...
public record Cable(CableId id, PedalId sourcePedalId, PedalId destinationPedalId,
		List<PathPoint> pathPoints, Length totalLength) {

	public Cable(CableId id, PedalId sourcePedalId, PedalId destinationPedalId,
			List<PathPoint> pathPoints, Length totalLength) {
